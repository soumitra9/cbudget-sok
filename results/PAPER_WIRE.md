# Paper section wiring (Stage 7)

| Paper section | Source artifact | Evidence label |
|---|---|---|
| S4 Anatomy | results/e0_anatomy/ | empirically-demonstrated |
| S6 Evaluation / C2 | results/c2_metrics.csv | documented |
